...
public class GamePanel extends JPanel implements ActionListener {
    ...
    GamePanel() {
        ...
        restartButton.setBounds((SCREEN_WIDTH - 120) / 2, SCREEN_HEIGHT / 2 + 50, 120, 50);
    ...
    public void gameOver(Graphics g) {
        ...
        g.drawString("Score: " + applesEaten, (SCREEN_WIDTH - metrics1.stringWidth("Score: " + applesEaten)) / 2, g.getFont().getSize() + 10);
